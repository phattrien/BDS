...
<div class="col-sm-6 col-md-4">
	<div class="thumbnail">
		...
		<div class="caption text-center">
			<h4><a class="show" href="{CONTENT.link}" data-content="{CONTENT.title}<br>{CONTENT.publtime}<br>{CONTENT.hometext}  <br> <strong>{LANG.vitri}: </strong> {CONTENT.vitri}. <strong>{LANG.gia}: </strong>{CONTENT.gia}  {CONTENT.dvt}/{CONTENT.dientich} {LANG.m2}." data-img="{CONTENT.imghome}" data-rel="tooltip">{CONTENT.title}</a></h4>
			
			<strong>{LANG.gia}: </strong>{CONTENT.gia}  {CONTENT.dvt}/{CONTENT.dientich} {LANG.m2}.<br>

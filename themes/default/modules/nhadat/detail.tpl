...
<!-- END: facebookjssdk -->
<div class="nhadat_column panel panel-default">
	<div class="panel-body">
<h1 style="text-align: center;color: #0014FF;font-weight: bold;">{DETAIL.title}
<strong style="color: #000;font-weight: initial;"> ({DETAIL.id})</strong>   </h1>
	...
	<div class="contact-default ">	
		...
		<ul>
			...
			<li>	<strong>{LANG.pubtime}: </strong>{DETAIL.publtime} 
			
		 		<li>	<strong>{LANG.status_3}: </strong>{DETAIL.exptime} </li>
			<li>	<strong>{LANG.view}: </strong>{DETAIL.hitstotal}</li> 
			<li>	</li> 
		
			<!-- BEGIN: lienhe --><li><strong>{LANG.lienhe}: </strong>{DETAIL.lienhe}</li> <!-- END: lienhe -->
			<!-- BEGIN: diachi --><li><strong>{LANG.diachi}: </strong>{DETAIL.diachi}</li><!-- END: diachi -->
			<!-- BEGIN: tel --><li><strong>{LANG.tel}: </strong>{DETAIL.tel}</li>		<!-- END: tel -->
			<!-- BEGIN: gia --><li><strong>{LANG.gia}: </strong>{DETAIL.gia} {DETAIL.dvt}</li>		<!-- END: gia -->	
			
			<!-- BEGIN: dientich --><li><strong>{LANG.dientich}: </strong>{DETAIL.dientich} {LANG.m2}</li>		<!-- END: dientich -->	
			
			<!-- BEGIN: vitri --><li><strong>{LANG.vitri}: </strong>{DETAIL.vitri}</li>		<!-- END: vitri -->	
			<!-- BEGIN: huong --><li><strong>{LANG.huong}: </strong>{DETAIL.huong}</li><!-- END: huong -->
			
			
		</ul>
			<!-- BEGIN: ghichu --><div><strong>{LANG.ghichu}: </strong>{DETAIL.ghichu}</div><!-- END: ghichu -->
	</div>
			...
			<!-- END: allowed_save -->
			 ...
			 <!-- BEGIN: socialbutton -->
        <li>
	        <li class="fb-like" data-href="{SELFURL}" data-width="The pixel width of the plugin" data-height="The pixel height of the plugin" data-colorscheme="light" data-layout="button_count" data-action="like" data-show-faces="true" data-send="false"></li>

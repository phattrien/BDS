...
<div class="nhadat_column">
	<div class="panel panel-default">
		<div class="panel-body">
			<!-- BEGIN: catcontent -->
				<!-- BEGIN: image -->
				<a href="{CONTENT.link}" title="{CONTENT.title}"><img id="imghome" alt="{HOMEIMGALT0}" src="{HOMEIMG0}" width="{IMGWIDTH0}" class="img-thumbnail pull-left" style="max-height: 100px;"/></a>
				<!-- END: image -->
				<h3>

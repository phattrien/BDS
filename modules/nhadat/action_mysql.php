...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_rows (
	 ...
	 lienhe varchar(255) default '',
	 diachi varchar(255) default '',
	 tel varchar(50) default '',
	 gia varchar(20) default '',
	 dvt varchar(20) default '',
	 vitri varchar(20) default '',
	 dientich varchar(20) default '',
	 huong varchar(60) default '',
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_tags (
	 ...
	 numnhadat mediumint(8) NOT NULL DEFAULT '0',
	 alias varchar(255) NOT NULL DEFAULT '',
	 image varchar(255) DEFAULT '',
	 description text,

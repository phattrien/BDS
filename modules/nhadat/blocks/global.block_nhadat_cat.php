...
if( ! nv_function_exists( 'nv_block_nhadat_cat' ) )
{
	function nv_block_config_nhadat_cat( $module, $data_block, $lang_block )
	{
		global $site_mods;
	...
	function nv_block_config_nhadat_cat_submit( $module, $lang_block )
	{
		global $nv_Request;
		$return = array();
		$return['error'] = array();
	...
	function nv_block_nhadat_cat( $block_config )
	{
...
if( defined( 'NV_SYSTEM' ) )
{
	...
	if( isset( $site_mods[$module] ) )
	{
		...
		$content = nv_block_nhadat_cat( $block_config );
	}
}

...
if( ! nv_function_exists( 'nv_nhadat_block_tophits' ) )
{
	...
	function nv_nhadat_block_tophits( $block_config, $mod_data )
	{
...
if( defined( 'NV_SYSTEM' ) )
{
	...
	if( isset( $site_mods[$module] ) )
	{
		...
		$content = nv_nhadat_block_tophits( $block_config, $mod_data );
	}
}
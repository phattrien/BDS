...
if( empty( $contents ) )
{
	...
	elseif( $viewcat == 'viewcat_main_left' or $viewcat == 'viewcat_main_right' or $viewcat == 'viewcat_main_bottom' )
	{
		...
		$key = 0;
		$db->sqlreset()
			->select('t1.id, t1.listcatid, t1.topicid, t1.admin_id, t1.author, t1.sourceid, t1.addtime, t1.edittime, t1.publtime, t1.title, t1.alias, t1.hometext, t1.homeimgfile, t1.homeimgalt, t1.homeimgthumb, t1.allowed_rating, t1.hitstotal, t1.hitscm, t1.total_rating, t1.click_rating, t2.newday, t1.lienhe,t1.diachi,t1.tel,t1.gia,t1.dvt,t1.huong,t1.vitri,t1.dientich, t1.ghichu' )
			->join( 'INNER JOIN ' . NV_PREFIXLANG . '_' . $module_data . '_cat t2 ON t1.catid = t2.catid' )
			->where( 't1.status= 1 AND t1.inhome=1' )
	...
	elseif( $viewcat == 'viewcat_grid_new' or $viewcat == 'viewcat_grid_old' )
	{
		...
		$db->select( 't1.id, t1.catid, t1.topicid, t1.admin_id, t1.author, t1.sourceid, t1.addtime, t1.edittime, t1.publtime, t1.title, t1.alias, t1.hometext, t1.homeimgfile, t1.homeimgalt, t1.homeimgthumb, t1.allowed_rating, t1.hitstotal, t1.hitscm, t1.total_rating, t1.click_rating, t2.newday, t1.lienhe,t1.diachi,t1.tel,t1.gia,t1.dvt,t1.huong,t1.vitri,t1.dientich,t1.ghichu' )
			->join( 'INNER JOIN ' . NV_PREFIXLANG . '_' . $module_data . '_cat t2 ON t1.catid = t2.catid' )
			->order( $order_by )
			->limit($per_page )
			->offset( ( $page - 1 ) * $per_page );
	...
	elseif( $viewcat == 'viewcat_list_new' or $viewcat == 'viewcat_list_old' ) // Xem theo tieu de
	{
		...
		$db->select( 't1.id, t1.listcatid, t1.catid, t1.topicid, t1.admin_id, t1.author, t1.sourceid, t1.addtime, t1.edittime, t1.publtime, t1.title, t1.alias, t1.hometext, t1.homeimgfile, t1.homeimgalt, t1.homeimgthumb, t1.allowed_rating, t1.hitstotal, t1.hitscm, t1.total_rating, t1.click_rating, t2.newday, t1.lienhe,t1.diachi,t1.tel,t1.gia,t1.dvt,t1.huong,t1.vitri,t1.dientich,t1.ghichu' )
			->join( 'INNER JOIN ' . NV_PREFIXLANG . '_' . $module_data . '_cat t2 ON t1.catid = t2.catid' )
			->order( $order_by )
			->limit($per_page )
			->offset( ( $page - 1 ) * $per_page );

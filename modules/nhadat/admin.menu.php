...
if( ! function_exists('nv_nhadat_array_cat_admin') )
{
	/**
	 * nv_nhadat_array_cat_admin()
	 *
	 * @return
	 */
	function nv_nhadat_array_cat_admin( $module_data )
	{
		global $db;
...
$is_refresh = false;
$array_cat_admin = nv_nhadat_array_cat_admin( $module_data );
...
if( $NV_IS_ADMIN_MODULE )
{
	...
	$allow_func[] = 'topicsnhadat';
	$allow_func[] = 'topics';
	$allow_func[] = 'topicdelnhadat';

...
$sql_create_module[] = "CREATE TABLE " . $db_config["prefix"] . "_" . $lang . "_" . $module_data . "_rows (
	 ...
	 lienhe VARCHAR2(255 CHAR) DEFAULT '',
	 diachi VARCHAR2(255 CHAR) DEFAULT '',
	 tel VARCHAR2(50 CHAR) DEFAULT '',
	 gia VARCHAR2(20 CHAR) DEFAULT '',
	 dvt VARCHAR2(20 CHAR) DEFAULT '',
	 vitri VARCHAR2(20 CHAR) DEFAULT '',
	 dientich VARCHAR2(20 CHAR) DEFAULT '',
	 huong VARCHAR2(60 CHAR) DEFAULT '',
	 ghichu VARCHAR2(255 CHAR) DEFAULT '',
...
$sql_create_module[] = "CREATE INDEX inv_" . $lang . "_" . $module_data . "_rtitle ON " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_rows(lienhe) TABLESPACE USERS";
$sql_create_module[] = "CREATE INDEX inv_" . $lang . "_" . $module_data . "_rtitle ON " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_rows(diachi) TABLESPACE USERS";
$sql_create_module[] = "CREATE INDEX inv_" . $lang . "_" . $module_data . "_rtitle ON " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_rows(tel) TABLESPACE USERS";
$sql_create_module[] = "CREATE INDEX inv_" . $lang . "_" . $module_data . "_rtitle ON " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_rows(gia) TABLESPACE USERS";
$sql_create_module[] = "CREATE INDEX inv_" . $lang . "_" . $module_data . "_rtitle ON " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_rows(dvt) TABLESPACE USERS";
$sql_create_module[] = "CREATE INDEX inv_" . $lang . "_" . $module_data . "_rtitle ON " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_rows(huong) TABLESPACE USERS";
$sql_create_module[] = "CREATE INDEX inv_" . $lang . "_" . $module_data . "_rtitle ON " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_rows(vitri) TABLESPACE USERS";
$sql_create_module[] = "CREATE INDEX inv_" . $lang . "_" . $module_data . "_rtitle ON " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_rows(dientich) TABLESPACE USERS";
$sql_create_module[] = "CREATE INDEX inv_" . $lang . "_" . $module_data . "_rtitle ON " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_rows(ghichu) TABLESPACE USERS";
...
$sql_create_module[] = "CREATE TABLE " . $db_config["prefix"] . "_" . $lang . "_" . $module_data . "_tags (
	 ...
	 numnhadat NUMBER(8,0) DEFAULT 0 NOT NULL ENABLE,
	 alias VARCHAR2(255 CHAR) DEFAULT '' NOT NULL ENABLE,
	 image VARCHAR2(255 CHAR) DEFAULT '',

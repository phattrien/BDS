...
$lang_module['deltopic_msg_rows'] = 'relevant nhadat group %s article, have you sure deleted, then group related information is deleted from the article?';
...
$lang_module['topic_delete_confirm'] = 'Are you sure you want to delete from nhadat groups related articles?';
$lang_module['topic_delete_success'] = 'Delete success!';
$lang_module['topic_nonhadat'] = 'There are currently no nhadat articles related to any of these groups';
$lang_module['addtotopics'] = 'Add topic';
$lang_module['topic_update_success'] = 'Update successful';
$lang_module['topic_num_nhadat'] = 'Topic';
...
$lang_module['facebookAppIDNote'] = '(Form: 1419186468293063, <a href="http://wiki.nukeviet.vn/nukeviet:admin:nhadat:facebookapi" target="_blank">view detail</a>)';
